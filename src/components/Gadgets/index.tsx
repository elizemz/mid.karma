...
export const Gadget = ({ brawler }: BrawlerProps) => {
  ...
  return (
    <li className="group flex flex-col justify-center duration-100 m-1 lg:m-2.5 border-indigo-300 border-opacity-40 hover:border-opacity-100 border rounded-r rounded-t lg:scale-125">
      <div className="flex">
        <div className="flex flex-row items-center bg-gray-950 rounded-t w-full w-max-[10px] gap-0.5">
          <div className="flex ml-0.5">
            <img
              className="w-3 pointer-events-none my-0.5 z-10"
            ...
            />
            <p className="text-[9px] absolute ml-[3.5px] mt-[1px] z-20">
